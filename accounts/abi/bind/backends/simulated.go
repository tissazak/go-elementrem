...
type SimulatedBackend struct {
	database   eledb.Database   // In memory database to store our testing data
	blockchain *core.BlockChain // Elementrem blockchain to handle the consensus
...
func NewSimulatedBackend(accounts ...core.GenesisAccount) *SimulatedBackend {
	database, _ := eledb.NewMemDatabase()
...
// BalanceAt returns the mey balance of a certain account in the blockchain.
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call elementrem.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call elementrem.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call elementrem.CallMsg) (*big.Int, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call elementrem.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, *big.Int, error) {
