...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Elementrem wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gele wallet import /path/to/my/presale.wallet

will prompt for your password and imports your element account.
		...
		Subcommands: []cli.Command{
			{
				Action:    importWallet,
				Name:      "import",
				Usage:     "Import Elementrem wallet",
				ArgsUsage: "<keyFile>",
				Description: `
...
between elementrem nodes by simply copying.
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    gele --password <passwordfile> account new
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    gele --password <passwordfile> account update <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    gele --password <passwordfile> account import <keyfile>

Note:
As you can directly copy your encrypted accounts to another elementrem instance,
