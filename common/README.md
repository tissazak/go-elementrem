...
RLP Encoding is an encoding scheme used by the Elementrem project. It
encodes any native value or list to a string.

More in depth information about the encoding scheme see the
[Wiki](http://wiki.elementrem.org/index.php/RLP) article.
...
Patricie Tree is a merkle trie used by the Elementrem project.

More in depth information about the (modified) Patricia Trie can be
found on the [Wiki](http://wiki.elementrem.org/index.php/Patricia_Tree).
