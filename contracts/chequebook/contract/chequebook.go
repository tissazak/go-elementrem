...
// DeployChequebook deploys a new Elementrem contract, binding an instance of Chequebook to it.
...
// Chequebook is an auto generated Go binding around an Elementrem contract.
type Chequebook struct {
	ChequebookCaller     // Read-only binding to the contract
	ChequebookTransactor // Write-only binding to the contract
}

// ChequebookCaller is an auto generated read-only Go binding around an Elementrem contract.
type ChequebookCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ChequebookTransactor is an auto generated write-only Go binding around an Elementrem contract.
type ChequebookTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ChequebookSession is an auto generated Go binding around an Elementrem contract,
...
// ChequebookCallerSession is an auto generated read-only Go binding around an Elementrem contract,
...
// ChequebookTransactorSession is an auto generated write-only Go binding around an Elementrem contract,
...
// ChequebookRaw is an auto generated low-level Go binding around an Elementrem contract.
type ChequebookRaw struct {
	Contract *Chequebook // Generic contract binding to access the raw methods on
}

// ChequebookCallerRaw is an auto generated low-level read-only Go binding around an Elementrem contract.
type ChequebookCallerRaw struct {
	Contract *ChequebookCaller // Generic read-only contract binding to access the raw methods on
}

// ChequebookTransactorRaw is an auto generated low-level write-only Go binding around an Elementrem contract.
...
// DeployMortal deploys a new Elementrem contract, binding an instance of Mortal to it.
...
// Mortal is an auto generated Go binding around an Elementrem contract.
type Mortal struct {
	MortalCaller     // Read-only binding to the contract
	MortalTransactor // Write-only binding to the contract
}

// MortalCaller is an auto generated read-only Go binding around an Elementrem contract.
type MortalCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// MortalTransactor is an auto generated write-only Go binding around an Elementrem contract.
type MortalTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// MortalSession is an auto generated Go binding around an Elementrem contract,
// with pre-set call and transact options.
...
// MortalCallerSession is an auto generated read-only Go binding around an Elementrem contract,
// with pre-set call options.
...
// MortalTransactorSession is an auto generated write-only Go binding around an Elementrem contract,
// with pre-set transact options.
...
// MortalRaw is an auto generated low-level Go binding around an Elementrem contract.
type MortalRaw struct {
	Contract *Mortal // Generic contract binding to access the raw methods on
}

// MortalCallerRaw is an auto generated low-level read-only Go binding around an Elementrem contract.
type MortalCallerRaw struct {
	Contract *MortalCaller // Generic read-only contract binding to access the raw methods on
}

// MortalTransactorRaw is an auto generated low-level write-only Go binding around an Elementrem contract.
...
// DeployOwned deploys a new Elementrem contract, binding an instance of Owned to it.
...
// Owned is an auto generated Go binding around an Elementrem contract.
type Owned struct {
	OwnedCaller     // Read-only binding to the contract
	OwnedTransactor // Write-only binding to the contract
}

// OwnedCaller is an auto generated read-only Go binding around an Elementrem contract.
type OwnedCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// OwnedTransactor is an auto generated write-only Go binding around an Elementrem contract.
type OwnedTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// OwnedSession is an auto generated Go binding around an Elementrem contract,
// with pre-set call and transact options.
...
// OwnedCallerSession is an auto generated read-only Go binding around an Elementrem contract,
// with pre-set call options.
...
// OwnedTransactorSession is an auto generated write-only Go binding around an Elementrem contract,
// with pre-set transact options.
...
// OwnedRaw is an auto generated low-level Go binding around an Elementrem contract.
type OwnedRaw struct {
	Contract *Owned // Generic contract binding to access the raw methods on
}

// OwnedCallerRaw is an auto generated low-level read-only Go binding around an Elementrem contract.
type OwnedCallerRaw struct {
	Contract *OwnedCaller // Generic read-only contract binding to access the raw methods on
}

// OwnedTransactorRaw is an auto generated low-level write-only Go binding around an Elementrem contract.
