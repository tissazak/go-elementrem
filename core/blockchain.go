...
// available in the database. It initialiser the default Elementrem Validator and
// Processor.
func NewBlockChain(chainDb eledb.Database, config *params.ChainConfig, pow pow.PoW, mux *event.TypeMux, vmConfig vm.Config) (*BlockChain, error) {
