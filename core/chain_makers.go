...
func GenerateChain(config *params.ChainConfig, parent *types.Block, db eledb.Database, n int, gen func(int, *BlockGen)) ([]*types.Block, []types.Receipts) {
...
// header only chain.
func newCanonical(n int, full bool) (eledb.Database, *BlockChain, error) {
...
func makeHeaderChain(parent *types.Header, n int, db eledb.Database, seed int) []*types.Header {
