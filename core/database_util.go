...
var (
	...
	configPrefix = []byte("elementrem-config-") // config prefix for the db
...
func GetCanonicalHash(db eledb.Database, number uint64) common.Hash {
...
func GetBlockNumber(db eledb.Database, hash common.Hash) uint64 {
...
func GetHeadHeaderHash(db eledb.Database) common.Hash {
...
func GetHeadBlockHash(db eledb.Database) common.Hash {
...
func GetHeadFastBlockHash(db eledb.Database) common.Hash {
...
func GetHeaderRLP(db eledb.Database, hash common.Hash, number uint64) rlp.RawValue {
...
// found.
func GetHeader(db eledb.Database, hash common.Hash, number uint64) *types.Header {
...
func GetBodyRLP(db eledb.Database, hash common.Hash, number uint64) rlp.RawValue {
...
func GetBody(db eledb.Database, hash common.Hash, number uint64) *types.Body {
...
// none found.
func GetTd(db eledb.Database, hash common.Hash, number uint64) *big.Int {
...
func GetBlock(db eledb.Database, hash common.Hash, number uint64) *types.Block {
...
func GetBlockReceipts(db eledb.Database, hash common.Hash, number uint64) types.Receipts {
...
func GetTransaction(db eledb.Database, hash common.Hash) (*types.Transaction, common.Hash, uint64, uint64) {
...
func GetReceipt(db eledb.Database, txHash common.Hash) *types.Receipt {
...
func WriteCanonicalHash(db eledb.Database, hash common.Hash, number uint64) error {
...
func WriteHeadHeaderHash(db eledb.Database, hash common.Hash) error {
...
func WriteHeadBlockHash(db eledb.Database, hash common.Hash) error {
...
func WriteHeadFastBlockHash(db eledb.Database, hash common.Hash) error {
...
func WriteHeader(db eledb.Database, header *types.Header) error {
...
func WriteBody(db eledb.Database, hash common.Hash, number uint64, body *types.Body) error {
...
func WriteBodyRLP(db eledb.Database, hash common.Hash, number uint64, rlp rlp.RawValue) error {
...
func WriteTd(db eledb.Database, hash common.Hash, number uint64, td *big.Int) error {
...
func WriteBlock(db eledb.Database, block *types.Block) error {
...
func WriteBlockReceipts(db eledb.Database, hash common.Hash, number uint64, receipts types.Receipts) error {
...
func WriteTransactions(db eledb.Database, block *types.Block) error {
	batch := db.NewBatch()
...
func WriteReceipt(db eledb.Database, receipt *types.Receipt) error {
...
func WriteReceipts(db eledb.Database, receipts types.Receipts) error {
	batch := db.NewBatch()
...
func DeleteCanonicalHash(db eledb.Database, number uint64) {
	db.Delete(append(append(headerPrefix, encodeBlockNumber(number)...), numSuffix...))
}

// DeleteHeader removes all block header data associated with a hash.
func DeleteHeader(db eledb.Database, hash common.Hash, number uint64) {
	db.Delete(append(blockHashPrefix, hash.Bytes()...))
	db.Delete(append(append(headerPrefix, encodeBlockNumber(number)...), hash.Bytes()...))
}

// DeleteBody removes all block body data associated with a hash.
func DeleteBody(db eledb.Database, hash common.Hash, number uint64) {
	db.Delete(append(append(bodyPrefix, encodeBlockNumber(number)...), hash.Bytes()...))
}

// DeleteTd removes all block total difficulty data associated with a hash.
func DeleteTd(db eledb.Database, hash common.Hash, number uint64) {
	db.Delete(append(append(append(headerPrefix, encodeBlockNumber(number)...), hash.Bytes()...), tdSuffix...))
}

// DeleteBlock removes all block data associated with a hash.
func DeleteBlock(db eledb.Database, hash common.Hash, number uint64) {
...
func DeleteBlockReceipts(db eledb.Database, hash common.Hash, number uint64) {
	db.Delete(append(append(blockReceiptsPrefix, encodeBlockNumber(number)...), hash.Bytes()...))
}

// DeleteTransaction removes all transaction data associated with a hash.
func DeleteTransaction(db eledb.Database, hash common.Hash) {
...
func DeleteReceipt(db eledb.Database, hash common.Hash) {
...
// network transitions to ele/63.
func GetBlockByHashOld(db eledb.Database, hash common.Hash) *types.Block {
...
// MIP bloom bin.
func WriteMipmapBloom(db eledb.Database, number uint64, receipts types.Receipts) error {
	mipmapBloomMu.Lock()
...
func GetMipmapBloom(db eledb.Database, number, level uint64) types.Bloom {
	bloomDat, _ := db.Get(mipmapKey(number, level))
	return types.BytesToBloom(bloomDat)
}

// PreimageTable returns a Database instance with the key prefix for preimage entries.
func PreimageTable(db eledb.Database) eledb.Database {
	return eledb.NewTable(db, preimagePrefix)
}

// WritePreimages writes the provided set of preimages to the database. `number` is the
// current block number, and is used for debug messages only.
func WritePreimages(db eledb.Database, number uint64, preimages map[common.Hash][]byte) error {
...
func GetBlockChainVersion(db eledb.Database) int {
	var vsn uint
...
func WriteBlockChainVersion(db eledb.Database, vsn int) {
	enc, _ := rlp.EncodeToBytes(uint(vsn))
	db.Put([]byte("BlockchainVersion"), enc)
}

// WriteChainConfig writes the chain config settings to the database.
func WriteChainConfig(db eledb.Database, hash common.Hash, cfg *params.ChainConfig) error {
...
func GetChainConfig(db eledb.Database, hash common.Hash) (*params.ChainConfig, error) {
...
func FindCommonAncestor(db eledb.Database, a, b *types.Header) *types.Header {
