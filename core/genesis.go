...
func WriteGenesisBlock(chainDb eledb.Database, reader io.Reader) (*types.Block, error) {
...
// GenesisBlockForTesting creates a block in which addr has the given mey balance.
// The state trie of the block is written to db. the passed db needs to contain a state root
func GenesisBlockForTesting(db eledb.Database, addr common.Address, balance *big.Int) *types.Block {
...
func WriteGenesisBlockForTesting(db eledb.Database, accounts ...GenesisAccount) *types.Block {
	accountJson := "{"
...
// WriteDefaultGenesisBlock assembles the official Elementrem genesis block and
// writes it - along with all associated state - into a chain database.
func WriteDefaultGenesisBlock(chainDb eledb.Database) (*types.Block, error) {
...
// writes it - along with all associated state - into a chain database.
func WriteTestNetGenesisBlock(chainDb eledb.Database) (*types.Block, error) {
	return WriteGenesisBlock(chainDb, strings.NewReader(DefaultTestnetGenesisBlock()))
}

// DefaultGenesisBlock assembles a JSON string representing the default Elementrem
// genesis block.
...
// DefaultTestnetGenesisBlock assembles a JSON string representing the default Elementrem
