...
// StateObject represents an Elementrem account which is being modified.
//
...
type StateObject struct {
	address common.Address // Elementrem address of this account
	data    Account
	db      *StateDB
...
// Account is the Elementrem consensus representation of accounts.
