...
// Package types contains data types related to Elementrem consensus.
package types
...
// Header represents a block header in the Elementrem blockchain.
type Header struct {
...
// Block represents an entire block in the Elementrem blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package ele to track
...
// [deprecated by ele/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for ele protocol, etc.
...
// DecodeRLP decodes the Elementrem
...
// EncodeRLP serializes b into the Elementrem RLP block format.
