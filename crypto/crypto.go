...
// Creates an elementrem address given the bytes and the nonce
...
//
// Note: secp256k1 expects the recover id to be either 0, 1. Elementrem
// signatures have a recover id with an offset of 27. Callers must take
// this into account and if "recovering" from an Elementrem signature adjust.
