...
// Syncing provides information when this nodes starts synchronising with the Elementrem network and when it's finished.
...
type SyncingResult struct {
	...
	Status  elementrem.SyncProgress `json:"status"`
}
