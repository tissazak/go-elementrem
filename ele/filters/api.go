...
// information related to the Elementrem protocol such als blocks, transactions and logs.
...
// `ele_getFilterChanges` polling method that is also used for log filters.
//
...
// It is part of the filter package since polling goes with ele_getFilterChanges.
//
// https://github.com/elementrem
