...
// Package elementrem defines interfaces for interacting with Elementrem.
package elementrem
...
type CallMsg struct {
	...
	GasPrice *big.Int        // mey <-> gas exchange ratio
	Value    *big.Int        // amount of mey sent along with the call
