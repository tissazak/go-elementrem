...
// for the Elementrem Light Client.
package les
...
type LesOdrRequest interface {
	...
	Valid(eledb.Database, *Msg) bool // if true, keeps the retrieved object
}
...
func (self *BlockRequest) Valid(db eledb.Database, msg *Msg) bool {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (self *ReceiptsRequest) Valid(db eledb.Database, msg *Msg) bool {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (self *TrieRequest) Valid(db eledb.Database, msg *Msg) bool {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (self *CodeRequest) Valid(db eledb.Database, msg *Msg) bool {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (self *ChtRequest) Valid(db eledb.Database, msg *Msg) bool {
