...
// Contains a wrapper for the Elementrem client.
...
type ElementremClient struct {
	client *eleclient.Client
}

// NewElementremClient connects a client to the given URL.
func NewElementremClient(rawurl string) (client *ElementremClient, _ error) {
	rawClient, err := eleclient.Dial(rawurl)
	return &ElementremClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *ElementremClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *ElementremClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *ElementremClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *ElementremClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *ElementremClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *ElementremClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *ElementremClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *ElementremClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *ElementremClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *ElementremClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
// GetBalanceAt returns the mey balance of the given account.
// The block number can be <0, in which case the balance is taken from the latest known block.
func (ec *ElementremClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *ElementremClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *ElementremClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *ElementremClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *ElementremClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *ElementremClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
// GetPendingBalanceAt returns the mey balance of the given account in the pending state.
func (ec *ElementremClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *ElementremClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *ElementremClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *ElementremClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *ElementremClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *ElementremClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *ElementremClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *ElementremClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *ElementremClient) EstimateGas(ctx *Context, msg *CallMsg) (gas *BigInt, _ error) {
...
func (ec *ElementremClient) SendTransaction(ctx *Context, tx *Transaction) error {
