...
// Contains all the wrappers from the go-elementrem root package.
...
// the Elementrem network.
type SyncProgress struct {
	progress elementrem.SyncProgress
}
