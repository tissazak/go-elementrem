...
// INTERSTELLARleapBlockExtra is the block header extra-data field to set for the INTERSTELLAR leap
// point and a number of consecutive blocks to allow fast/light syncers to correctly
// pick the side they want  ("interstellar-hard-leap").
var INTERSTELLARleapBlockExtra = common.FromHex("0x7065726d616e656e746c7920656e6c617267696e67")

// INTERSTELLARleapExtraRange is the number of consecutive blocks from the INTERSTELLAR leap point
// to override the extra-data in to prevent no-leap attacks.
