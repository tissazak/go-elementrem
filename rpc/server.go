...
const (
	...
	MetadataApi     = "rpc"
	DefaultIPCApis  = "admin,debug,ele,miner,net,personal,shh,txpool,web3"
	DefaultHTTPApis = "ele,net,web3"
)
...
func (s *Server) readRequest(codec ServerCodec) ([]*serverRequest, bool, Error) {
	...
	for i, r := range reqs {
		...
		if r.isPubSub { // ele_subscribe, r.method contains the subscription method name
