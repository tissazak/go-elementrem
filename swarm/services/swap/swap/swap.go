...
type Strategy struct {
	...
	AutoCashThreshold    *big.Int      // threshold that triggers autocash (mey)
	AutoDepositInterval  time.Duration // default interval for autocash
	AutoDepositThreshold *big.Int      // threshold that triggers autodeposit (mey)
	AutoDepositBuffer    *big.Int      // buffer that is surplus for fork protection etc (mey)
}
